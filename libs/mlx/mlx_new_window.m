...
void *mlx_new_window(ptr_t *ptr, int size_x, int size_y, char *title)
{
  win_list_t	*newwin;
  NSString		*str;
...
void mlx_clear_window(ptr_t *ptr, win_list_t *win_ptr)
{
...
void mlx_expose_hook(win_list_t *win_ptr, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:12 andFunc:funct_ptr andParam:param];
}

void mlx_key_hook(win_list_t *win_ptr, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:3 andFunc:funct_ptr andParam:param];
}

void mlx_mouse_hook(win_list_t *win_ptr, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:4 andFunc:funct_ptr andParam:param];
}

void mlx_hook(win_list_t *win_ptr, int x_event, int x_mask, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:x_event andFunc:funct_ptr andParam:param];
}

int     mlx_do_key_autorepeatoff(ptr_t *ptr)
{
  win_list_t *win;
...
int     mlx_do_key_autorepeaton(ptr_t *ptr)
{
  win_list_t *win;
...
int     mlx_destroy_window(ptr_t *ptr, win_list_t *win_to_del)
{
  win_list_t    first;
  win_list_t    *win;
  mlx_img_ctx_t	    *ctx;
