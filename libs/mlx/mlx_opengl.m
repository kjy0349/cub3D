...
void	*mlx_new_opengl_window(ptr_t *ptr, int size_x, int size_y, char *title)
{
  win_list_t	*newwin;
  NSString		*str;
...
int	mlx_opengl_swap_buffers(win_list_t *win_ptr)
{
  [(id)(win_ptr->winid) flushGLContext];
  return (0);
}

int	mlx_opengl_window_set_context(win_list_t *win_ptr)
{
